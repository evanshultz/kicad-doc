...
The follwing sections will step through creating PCB fabrication files for a
new project. Each phase of this process will be covered in brief and should
be used as a guide to become familiar with KiCad.
...
=== Exporting, importing and modifying library components
...
=== Making components with Quicklib
...
=== Making a high pin count component
...
== Portability of KiCad project files
...
== KiCad support and documentation
...
* http://kicad-pcb.org/help/documentation/[View the documentation online]
